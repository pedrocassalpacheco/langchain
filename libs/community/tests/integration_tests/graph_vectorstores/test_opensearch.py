...
from langchain_astradb.graph_vectorstores import OpenSearchGraphVectorStore
...
@pytest.fixture
def opensearch_graph_vector_store() -> OpenSearchGraphVectorStore:
    """Fixture to set up and return an OpenSearchGraphVectorStore instance.

    This function loads environment variables from a .env file, accesses the necessary
    variables for connecting to an OpenSearch instance, and prints the connection details.

    Returns:
        OpenSearchGraphVectorStore: An instance of OpenSearchGraphVectorStore configured
        with the specified host, port, authentication, and index name.
    """
...
def populated_graph_vector_store_vz(
    graph_vector_store_vz: OpenSearchGraphVectorStore,
...
def autodetect_populated_graph_vector_store_d2(
    ...
    g_store = OpenSearchGraphVectorStore(
        embedding=embedding_d2,
...
class TestAstraDBGraphVectorStore:
    ...
    def test_gvs_similarity_search_sync(
        ...
        *,
        ...
        g_store: OpenSearchGraphVectorStore = request.getfixturevalue(store_name)
    ...
    def test_gvs_from_texts(
        ...
        *,
        ...
        g_store = OpenSearchGraphVectorStore.from_texts(
            texts=page_contents,
            metadatas=[{"md": 1}],
            ids=["x_id"],
    ...
    async def test_gvs_from_texts_async(
        ...
        *,
        ...
        g_store = await OpenSearchGraphVectorStore.afrom_texts(
            texts=page_contents,
            metadatas=[{"md": 1}],
            ids=["x_id"],
            collection_name=collection_name,
    ...
    def test_gvs_from_documents_containing_ids(
        ...
        *,
        ...
        g_store = OpenSearchGraphVectorStore.from_documents(
    ...
    async def test_gvs_from_documents_containing_ids_async(
        ...
        *,
        ...
        g_store = await OpenSearchGraphVectorStore.afrom_documents(
            documents=[the_document],
            collection_name=collection_name,
            content_field=content_field,
            **auth_kwargs,
